...
export const getLocations = () => {
    return fetch(`https://api.foursquare.com/v2/venues/explore?cat=food&near=east-village-new-york&client_id=${CLIENT_ID}&client_secret=${CLIENT_SECRET}&v=20180323`)
        .then(resp => resp.json())
